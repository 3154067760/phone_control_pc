    ...
    for cmd in cmd_list:
        ...
        if action == "open":
            ...
            app_paths = {
                ...
                "soda": r"D:\software\Soda Music\SodaMusicLauncher.exe"  # 新增汽水音乐路径
            }
            if app in app_paths:
                try:
...
def index():
    ...
    <body>
        <h2>🤖 AI 控制电脑（支持多条指令）</h2>
        <form action="/command" method="post">
            <textarea name="command" rows="4" placeholder="说一句话即可，例如：
打开QQ 关闭微信 关机
打开汽水音乐 关闭PyCharm"></textarea>
            <button type="submit">🚀 让AI执行</button>
        </form>
    </body>
    </html>
    '''
