...
def index():
    ...
    <body>
        ...
        <button class="btn-blue" onclick="location.href='/open_weixin'">🔵 打开微信（自动回车）</button>
        <button class="btn-blue" onclick="location.href='/open_doubao'">🔵 打开豆包</button>
        ...
        <!-- ✅ 这里加了关闭微信按钮 -->
        <button class="btn-red" onclick="location.href='/close_weixin'">🔴 关闭微信</button>
        <!-- ✅ 这里加了关闭Edge浏览器按钮 -->
        <button class="btn-red" onclick="location.href='/close_edge'">🔴 关闭Edge浏览器</button>
